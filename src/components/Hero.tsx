function Hero() {
  return (
    <section id="home" className="min-h-[70vh] md:min-h-screen text-slate-900 dark:text-white flex flex-col justify-center px-6 md:px-20 py-10 md:py-16 transition-colors">
      <p className="text-slate-600 dark:text-slate-400 text-lg mb-4">Hello</p>

      <h1 className="text-2xl sm:text-3xl md:text-6xl font-bold leading-tight max-w-4xl">
        I'm{" "}
