function About() {
  return (
    <section id="about" className="bg-slate-950 text-white px-6 md:px-20 py-12 md:py-24">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <p className="text-slate-300 mb-4 leading-relaxed">
          I'm Adebisi Akinola Matthew, a self-taught Fullstack Developer who learned
