        ...
        {projects.slice(0, visibleCount).map((project) => (
          ...
          >
            ...
            <div className="p-5 sm:p-6">
              <span className="inline-block text-xs font-medium px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 mb-4">
                {project.tag}
              </span>
              ...
              <div className="flex gap-2 flex-wrap mb-5">
                {project.tech.map((t) => {
                  ...
                  return (
                    <span
                      key={t}
                      className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300"
                    >
              ...
              {project.inDevelopment && (
                <span className="text-amber-600 dark:text-amber-400 text-xs font-medium block mb-3">
                  In Development
                </span>
              )}
              ...
              {project.link && (
                <a
                  href={project.link}
                  target="_blank"
                  className={`inline-flex items-center gap-2 text-sm font-semibold text-white px-5 py-2.5 rounded-full bg-gradient-to-r ${project.color} hover:scale-105 transition-transform duration-200`}
                >
